...
export const useMenuStore = defineStore('menu', () => {
	...
	const products = ref([
		...
		},
		{
			...
			category: 'cookies',
			price: 65,
			image: '/cookies/megulgalutHalva.jpg',
			description:
		...
		},
		{
			...
			image: '/bread/sweetRools.png',
			description:
				'חלה מתוקה עם צימוקים עסיסיים. חלה רכה ומתוקה בסגנון ביתי לארוחת בוקר מפנקת. אהובות על ילדים - מאפיית מרגליתות בית שמש',
		},
		...
		// 	price: 85,
		// 	image: '',
		// 	description: 'קליעת בצק עלים פריכה עם מילוי בצל ופטריות, אפוי. מאפיית מרגליתות בית שמש',
		// },
		{
			id: 152,
		...
		},
		{
			...
			hasOptions: true,
			flavors: [
				{ id: 'greek', name: 'יווני', icon: '🍠' },
				{ id: 'cabage', name: 'כרוב', icon: '🥦' },
				{ id: 'borgul', name: 'בורגול/קינואה', icon: '🥬' },
				{ id: 'tuna', name: 'טונה', icon: '🍄' },
				{ id: 'halumi', name: 'חלומי', icon: '🌿' },
			],
		},
		...
		// },
		{
			...
			description:
				'פלטת ירקות טריים מעוצבת. מגוון ירקות עונתיים צבעוניים. פלטה מרשימה ובריאה לאירועים, למסיבות ולארוח אורחים. מעוצבת בדיוק בקו העיצוב של מאפיית מרגליתות בית שמש.',
		},
		{
			id: 165,
			name: 'פלטת פירות',
		...
		{
			id: 170,
			name: 'קינוחי כוסות מעוצבים חלבי',
			category: 'events',
			subcategory: 'events',
			price: 300,
		...
		{
			id: 210,
			name: 'חוג אפייה לגילאי 3.5-12',
			category: 'baking-workshops',
			price: 0,
			image: '/margalitaf1.jpeg',
			description:
				'חוג אפייה מקצועי לילדים בקבוצות גיל מותאמות - גילאי 3.5-12. הילדים לומדים לאפות מתוך הנאה, יצירתיות ועצמאות. כל קבוצה מותאמת לרמת הגיל עם מתכונים מיוחדים. חוג שבועי במרגליטף מבית מרגליתות',
			popular: true,
		},
		{
			id: 211,
			name: 'חוג בישול לגילאי 9-12',
			category: 'baking-workshops',
			price: 0,
			image: '/margalitaf2.jpeg',
			description:
				'חוג בישול לילדים גדולים גילאי 9-12 - לומדים טכניקות בישול אמיתיות, מתכונים מורכבים יותר ועצמאות במטבח. הילדים יוצאים עם מיומנויות שיישמשו אותם לכל החיים. חוג שבועי במרגליטף מבית מרגליתות',
		},
		{
			id: 212,
			name: 'יצירה בעקבות סיפור לגילאי 4-9',
			category: 'baking-workshops',
			price: 0,
			image: '/margalitaf1.jpeg',
			description:
				'חוג יצירה ייחודי לגילאי 4-9 שמשלב סיפור ודמיון עם יצירה ביד. כל מפגש מתחיל בסיפור קסום שממנו הילדים יוצרים יצירת אמנות משלהם. חוג מפתח יצירתיות, ריכוז ואהבה לאמנות. במרגליטף מבית מרגליתות',
		},
		{
			id: 213,
			name: 'חוג אוריגמי וקיפולי מפיות לגילאי 6-12',
			category: 'baking-workshops',
			price: 0,
			image: '/margalitaf2.jpeg',
			description:
				'חוג אוריגמי וקיפולי מפיות לילדים גילאי 6-12 - אמנות קיפול הנייר היפנית שמפתחת סבלנות, ריכוז וקואורדינציה עדינה. מדגמים פשוטים ועד מורכבים לפי הרמה. חוג מרגיע ומאתגר בו-זמנית. במרגליטף מבית מרגליתות',
		},
	]);
