...
export const useMenuStore = defineStore('menu', () => {
	...
	const products = ref([
		...
		{ id: 45, name: 'עוגיות חמאה', category: 'cookies', price: 40, image: '', description: 'עוגיות חמאה פריכות קלאסיות' },
		{ id: 46, name: 'סהרוני שקדים', category: 'cookies', price: 50, image: '', description: 'סהרוני שקדים פריכות' },
		{
			id: 47,
			name: 'עוגיות בריאות',
			category: 'cookies',
		...
		{ id: 50, name: 'קוקילידה', category: 'cookies', price: 12, image: '', description: 'קוקילידה' },
		{ id: 51, name: 'חיתוכיות תות תפוח', category: 'cookies', price: 45, image: '', description: 'חיתוכיות תות תפוח' },
		{ id: 52, name: 'עוגיות לוקום', category: 'cookies', price: 50, image: '', description: 'עוגיות רחת לוקום' },
		{
			id: 53,
		...
		{ id: 58, name: 'עוגיות לימון', category: 'cookies', price: 50, image: '', description: 'עוגיות לימון' },
		{ id: 59, name: 'עוגיות קפה', category: 'cookies', price: 50, image: '', description: 'עוגיות קפה' },
		{ id: 60, name: 'עוגיות פרג', category: 'cookies', price: 50, image: '', description: 'עוגיות פרג' },
		{ id: 61, name: 'מגולגלות חלבה', category: 'cookies', price: 50, image: '', description: 'מגולגלות חלבה' },
		{
			id: 62,
